...
Aqui encontram-se os requisitos do projeto. Para acessar a descrição completa das demandas, veja o quadro _Kanban_ disponibilizado para o seu grupo na [aba Projects](https://github.com/tryber/sd-04-project-frontend-online-store-12/projects) do repositório.
...
1. Clone o repositório
  * `git clone git@github.com:tryber/sd-04-project-frontend-online-store-12.git`.
  * Entre na pasta do repositório que você acabou de clonar:
    * `cd sd-04-project-frontend-online-store-12`
...
6. Crie um novo `Pull Request` _(PR)_
  * Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-04-project-frontend-online-store-12/pulls)
  ...
  * Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-04-project-frontend-online-store-12/pulls) e confira que o seu _Pull Request_ está criado
